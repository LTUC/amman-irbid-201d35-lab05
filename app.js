...
function multiply(a, b) {
    let product= a*b;
    let output = `The product of 5 and 9 is 45.`
...
function sumAndMultiply(a, b, c) {
    let sum = a+b+c;
    let product = a*b*c
    let output = "4 and 7 and 5 sum to 16."
    let output2= "The product of 4 and 7 and 5 is 140."
    return[sum, product, output, output2]
}
